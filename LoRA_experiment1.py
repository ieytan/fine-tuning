...
train_dataset = get_preprocessed_samsum({}, tokenizer, "train[1:100]")
test_dataset = get_preprocessed_samsum({}, tokenizer, "validation[1:100]")
...
# import torch
model.save_pretrained("LoRA_experiment1")
model = LlamaForCausalLM.from_pretrained(
            "LoRA_experiment1",
            device_map=device,
            use_cache=True if torch.cuda.is_available() else False,
